...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2023 a las 21:48:17
...
--
-- Volcado de datos para la tabla `colores_producto`
--
...
--
ALTER TABLE `colores_producto`
  ADD CONSTRAINT `colores_producto_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tallas_producto`
  ADD CONSTRAINT `tallas_producto_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE;
COMMIT;
